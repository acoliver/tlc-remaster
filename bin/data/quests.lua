...
Requirement codes:
	2 = item
	10 = explore star system by star ID - for example { 10, 20, 0 },
	12 = orbit planet by planet ID
	14 = scan planet by planet ID
	16 = land on planet by planet ID
	18 = enter starport personnel module
	20 = enter starport trade depot
	22 = enter starport docking bay
	24 = enter starport bank

reward = { code, item ID, amount }
Reward codes:
	0 = special: YOU SAVED THE GALAXY
...
QUEST SUMMARY:
	TRAINING
		...
		4-10: original starport training
		11-25: original gameplay training
	PLOT STAGE 1
		26-35: CLASS QUESTS
	PLOT STAGE 2
		36-46: VIRUS QUESTS
...
-- quest 3: Return the Hypercube from Ciuin in the Faidh system, 96N X 31E
	...
	--[[
	Missions #4-10: Unused (previously used for starport training)
	--]]
	addQuest( "TLC04","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC05" )
	addQuest( "TLC05","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC06" )
	addQuest( "TLC06","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC07" )
	addQuest( "TLC07","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC08" )
	addQuest( "TLC08","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC09" )
	addQuest( "TLC09","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC10" )
	addQuest( "TLC10","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC11" )

	--[[
	Missions #11-24: Unused (previously used to give player a running start)
	--]]
	addQuest( "TLC11","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC12" )
	addQuest( "TLC12","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC13" )
	addQuest( "TLC13","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC14" )
	addQuest( "TLC14","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC15" )
	addQuest( "TLC15","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC16" )
	addQuest( "TLC16","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC17" )
	addQuest( "TLC17","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC18" )
	addQuest( "TLC18","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC19" )
	addQuest( "TLC19","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC20" )
	addQuest( "TLC20","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC21" )
	addQuest( "TLC21","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC22" )
	addQuest( "TLC22","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC23" )
	addQuest( "TLC23","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC24" )
	addQuest( "TLC24","Unused Training Mission","",	"",	"",	0, 0, 0, 0, 0, 0, "TLC25" )

		--[[
		This is a repeat of the last training mission. Data in this quest will show up when the player 
		successfully completes the last training mission so the text must be identical.
		--]]
...
function init_science_missions()
	...
	--[[
	Science Mission #28: Multiple requirements are not implemented, so the game checks to see if the player landed on 111: Caintigern I (106,18). 
	Upon returning, the player receives 25,000 monetary units.
	--]]
	addQuest( 
		"TLC28",
		"Soil Samples",
	...
	--[[
	Science Mission #29: Pickup the data core on planet Tuatha, Nemed (125,96) at coordinates 40N X 63E. 
	When this is taken to the Bar-zhon, a dialogue sequence is triggered, the player engine class is upgraded if less than max, and the quest is completed.
	--]]
	addQuest( 
		"TLC29",
		"First Contact",
...
�	Elowan wary, denies the plague's existence
...
--[[
Quest Removed: 10. (War planet/G�nunk planet where all lifeforms are dangerous and hostile. New planet type / dozens of ruins) 
--]]
...
function getActiveQuest()
	...
	quest_id = quests[active_quest].quest_id
	...
	next_id = quests[active_quest].next_id

	getPlotStage()
end

--[[
*** THIS NEEDS TO BE MODIFIED TO NOT USE NUMBERING
--]]
function getPlotStage()
	-- 1-25 training quests
	-- 26-35 class quests
