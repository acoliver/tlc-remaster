...
void ModuleBank::Draw()
{
	...
	{//help window
		if(b_help_visible){
			...
			al_draw_bitmap_region(bmp_help_window, 0, 0, al_get_bitmap_width(bmp_help_window), al_get_bitmap_height(bmp_help_window), HELP_WINDOW_X, HELP_WINDOW_Y, 0);
...
void ModuleBank::render_images(){
	{
		al_set_target_bitmap(g_game->GetBackBuffer());
		al_draw_bitmap_region(bmp_bank_background, 0, 0, al_get_bitmap_width(g_game->GetBackBuffer()), al_get_bitmap_height(g_game->GetBackBuffer()), 0, 0, 0);//render background
		al_draw_bitmap_region(bmp_bank_banner, 0, 0, al_get_bitmap_width(bmp_bank_banner), al_get_bitmap_height(bmp_bank_banner), BANK_BANNER_X, BANK_BANNER_Y, 0);//render background
	}
	{//exit button
