...
void ModuleCargoWindow::Draw()
{
	...
	//drawing the window
	al_set_target_bitmap(g_game->GetBackBuffer()); al_draw_bitmap_region(img_viewer, 0, 0, al_get_bitmap_width(img_viewer), al_get_bitmap_height(img_viewer), m_x, m_y, 0);
